  ...
  {:editor                     {:forms               nil
   ...
   :application                {:applications                      []
                                ...
                                :kevyt-valinta-vastaanotto-state-counts
                                                                   (into {} (map #(vector (first %) 0) review-states/kevyt-valinta-vastaanoton-tila-selection-states))
                                ...
                                :kevyt-valinta-vastaanotto-state-filter
                                                                   (set (mapv first review-states/kevyt-valinta-vastaanoton-tila-selection-states))

...
(defn- kansainvalinen-yo-arvosana-info [id]
...
(defn- kansainvalinen-yo
  ...
  [(kansainvalinen-yo-arvosana-info
   ...
   {:fieldClass "formField"
    ...
    :label      {:en "Year of completion"
                 :fi "Suoritusvuosi"
                 :sv "Avlagd år"}
    :options    [{:followups [(liite (str type "--this-year-predicted")
                                     this-year-predicted-label)
                              (liite (str type "--this-year-diploma")
                                     this-year-diploma-label)]
                  :label     {:en "Valmistun kuluvana vuonna"
                              :fi "Valmistun kuluvana vuonna"
                              :sv "Valmistun kuluvana vuonna"}
                  :value     "0"}
                 {:followups [{:belongs-to-hakukohteet []
                              ...
                              (liite (str type "--previous-year-diploma")
                                     previous-year-diploma-label)]
                  :label     {:en "Olen jo valmistunut"
                              :fi "Olen jo valmistunut"
                              :sv "Olen jo valmistunut"}
                  :value     "1"}]
    :params     {}
    :validators ["required"]}])
  ...
  [{:followups [{:belongs-to-hakukohteet []
                 ...
                 :options                [{:followups [{:belongs-to-hakukohteet []
                                          ...
                                          {:followups [{:belongs-to-hakukohteet []
                                                       ...
                                                       (liite "pohjakoulutus-yo--attachment"
   ...
   {:followups [{:belongs-to-hakukohteet []
                 ...
                 :params                 {:numeric true
                                          ...
                                          :size "S"}
                 :validators             ["required" "numeric"]}
                (liite "pohjakoulutus_lk--attachment"
   ...
   {:followups [{:fieldClass "formField"
                ...
                {:fieldClass "formField"
                 ...
                 :params     {}
                 :validators ["required"]}
                (liite "pohjakoulutus_yo_ammatillinen--attachment"
   ...
   {:followups [{:children   [{:fieldClass "formField"
                              ...
                              {:fieldClass "formField"
                               ...
                               :params     {}
                               :validators ["required"]}
                              (liite "pohjakoulutus_am--attachment"
                                     {:en "Vocational qualification"
   ...
   {:followups [{:children   [{:fieldClass "formField"
                              ...
                              {:fieldClass "formField"
                               ...
                               :params     {}
                               :validators ["required"]}
                              (liite "pohjakoulutus_amt--attachment"
   ...
   {:followups [{:children   [{:belongs-to-hakukohteet []
                              ...
                              {:fieldClass "formField"
                               ...
                               :params     {}
                               :validators ["required"]}
                              (liite "pohjakoulutus_kk--attachment"
   ...
   {:followups [{:children   [{:belongs-to-hakukohderyhma []
                              ...
                              {:belongs-to-hakukohteet []
                               ...
                               :params                 {}
                               :validators             ["required"]}
                              (liite "pohjakoulutus_ulk--attachment"
   ...
   {:followups [{:children   [{:belongs-to-hakukohteet []
                              ...
                              {:belongs-to-hakukohteet []
                               ...
                               :params                 {}
                               :validators             ["required"]}
                              (liite "pohjakoulutus_kk_ulk--attachement"
   ...
   {:followups [{:children   [{:fieldClass "formField"
                              ...
                              {:fieldClass "formField"
                               ...
                               :validators ["required" "numeric"]}
                              (liite "pohjakoulutus_avoin--attachment"
   ...
   {:followups [{:fieldClass "formField"
                ...
                {:fieldClass "formField"
                 ...
                 :validators ["required"]}
                (liite "pohjakoulutus_muu--attachment"
         ...
         (clojure.walk/postwalk
          ...
          {:children   [{:belongs-to-hakukohteet   []
                         ...
                         :label                    {:en "Fill in the education that you have completed or will complete during the admission process."
                                                    ...
                                                    :sv "Ange utbildningar som du har avlagt. Ange också dem som du avlägger under ansökningsperioden."}

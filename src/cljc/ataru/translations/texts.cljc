...
(def translation-mapping
  {:lisaa-kieli                                 {:fi "Lisää kieli"
   ...
   :email-vain-harkinnanvaraisessa              {:fi "Olet hakenut yhteishaussa perusopetuksen jälkeiseen koulutukseen. Pohjakoulutustietosi mukaan olet mukana vain harkintaan perustuvassa valinnassa."
                                                 ...
                                                 :en "You have applied in the joint application to upper secondary education and preparatory education. Based on your educational background, you are considered only through discretionary admission."}
   ...
   :email-myos-pistevalinnassa                  {:fi "Olet hakenut yhteishaussa perusopetuksen jälkeiseen koulutukseen. Hakemuksellasi ilmoittamiesi tietojen perusteella sait ilmoituksen, että hakemuksesi käsitellään harkinnanvaraisessa valinnassa. Oppilaitoksesi mukaan tämä tieto on ollut virheellinen, joten hakemuksesi käsitellään normaalissa pistevalinnassa harkinnanvaraisen valinnan sijaan."
                                                 ...
                                                 :en "You have applied to upper secondary or preparatory education in the joint application. Based on the information you provided in your application, you received a notification that your application will be processed through discretionary admission. However, according to your educational institution, this information was incorrect, and your application will instead be processed through the standard scoring selection."}
...
(def kk-application-payment-module-texts
  {:section-title                      {:fi "Hakemusmaksu ja lukuvuosimaksu"
   ...
   :brexit-option                      {:fi "Brexit-oleskelulupakortti, lupatyyppi SEU-sopimuksen 50 artikla = Erosopimuksen piiriin kuuluva oleskeluoikeus, tai  P SEU-sopimuksen 50 artikla = Erosopimuksen mukainen pysyvä oleskeluoikeus"
                                        :sv "Brexit-uppehållstillståndskort, tillståndstyp EU-fördraget artikel 50 = Uppehållsrätt i enlighet med utträdesavtalet, eller P EU-fördraget artikel 50 = Permanent uppehållsrätt i enlighet med utträdesavtalet"
   ...
   :no-document-option                 {:fi "Minulla ei ole mitään alla mainituista dokumenteista, tai minulla on opiskelun perusteella myönnetty jatkuva oleskelulupa Suomessa (oleskelulupatyyppi A)"
                                        :sv "Jag har inget av nedanstående dokument, eller så har jag ett kontinuerligt uppehållstillstånd i Finland (tillståndstyp A) beviljat för studier."
                                        :en "I do not have any of the below, or I have a type A continuous residence permit in Finland issued for studies"}
   ...
   :passport-info                      {:fi "Huomiothan, että jos sinulla ei ole EU- tai ETA-maan tai Sveitsin passia, niin valitse vaihtoehto ”Minulla ei ole mitään alla mainituista dokumenteista, tai minulla on opiskelun perusteella myönnetty jatkuva oleskelulupa Suomessa (oleskelulupatyyppi A)” tai vaihtoehto, joka vastaa muuten tilannettasi. "
                                        :sv "Observera att om du inte har pass där ditt medborgarskap i EU/EES/Schweiz framgår, ska du välja ”Jag har inget av nedanstående dokument, eller så har jag ett kontinuerligt uppehållstillstånd i Finland (tillståndstyp A) beviljat för studier” eller ett alternativ som annars motsvarar din situation."
                                        :en "Please note that if your passport is not an EU/EEA or Switzerland passport, please choose the option ”I do not have any of the below, or I have a type A continuous residence permit in Finland issued for studies”, or choose the option that matches your situation otherwise."}
   :protection-info                    {:fi "Katso lisätietoa tilapäisen suojelun oleskeluluvasta [Maahanmuuttoviraston sivuilta](https://migri.fi/tilapainen-suojelu)."
                                        :sv "Läs mer om tillfälligt skydd i Finland på [Migrationsverkets webbplats](https://migri.fi/sv/tillfalligt-skydd)."
                                        :en "For information about temporary protection, please view [Migri's website](https://migri.fi/en/temporary-protection)."}
   :none-passport-info                 {:fi "Ilmoittamiesi tietojen perusteella sinulla ei ole maksusta vapauttavia dokumentteja, joten sinun tulee maksaa 100 euron suuruinen hakemusmaksu viimeistään 7 vuorokauden kuluttua hakemuksen lähettämisestä. Eräpäivä lasketaan siitä, kun ensimmäisen kerran painat ”Lähetä hakemus” -nappia. Saat hakulomakkeen lähettämisen jälkeen hakemusmaksun maksuohjeet sähköpostiisi.\n\nJos olet jo maksanut hakemusmaksun toisen haun yhteydessä, sinun ei tarvitse maksaa hakemusmaksua uudelleen. Et saa tällöin uutta maksulinkkiä.\n\nHuomioithan, että hakemusmaksun maksaminen ei vielä tarkoita, että sinut hyväksytään koulutukseen.\n\nJos haet muuhun kuin suomen- tai ruotsinkieliseen koulutukseen, sinun tulee maksaa myös lukuvuosimaksu, jos sinut hyväksytään koulutukseen."
                                        :sv "Enligt de uppgifter som du angett har du inte dokument som befriar dig från ansökningsavgiften. Du måste alltså betala en ansökningsavgift på 100 euro inom 7 dygn från att du skickat ansökningsblanketten. Förfallodagen räknas från och med den dag då du första gången trycker på ”skicka ansökan”. Efter att du skickat ansökningsblanketten får du anvisningar för hur du betalar ansökningsavgiften till din e-post.\n\nObservera att betalning av ansökningsavgift ännu inte innebär att du blir antagen till utbildningen.\n\nOm du söker till annat än svensk- eller finskspråkig utbildning, ska du också betala en läsårsavgift ifall du blir antagen till utbildningen."
                                        :en "Based on the information you have provided, you do not have any documents that exempt you from paying the application fee. You are required to pay the application fee of 100 euros within seven (7) days of submitting your application. The due date is calculated from the first time you press the ”submit application” button. After submitting your application, you will receive instructions on how to pay the application fee, along with a payment link.\n\nIf you have already paid the application fee in a previous application, you do not need to pay it again. In this case, you will not receive a new payment link.\n\nPlease note that paying the application fee does not automatically guarantee admission.\n\nAdditionally, if you are applying to degree programmes that are not in Finnish or Swedish, please note that you also need to pay an annual tuition fee if you are offered admission."}})
...
(def email-link-section-texts {:default              {:fi "Voit katsella ja muokata hakemustasi yllä olevan linkin kautta. Älä jaa linkkiä ulkopuolisille. Jos käytät yhteiskäyttöistä tietokonetta, muista kirjautua ulos sähköpostiohjelmasta.\n\nJos sinulla on verkkopankkitunnukset, mobiilivarmenne tai sähköinen henkilökortti, voit vaihtoehtoisesti kirjautua sisään [Opintopolku.fi](https://www.opintopolku.fi):ssä, ja tehdä muutoksia hakemukseesi Oma Opintopolku -palvelussa hakuaikana. Oma Opintopolku -palvelussa voit lisäksi nähdä valintojen tulokset ja ottaa opiskelupaikan vastaan."
                               ...
                               :eidas                {:fi "Voit katsella ja muokata hakemustasi yllä olevan linkin kautta. Älä jaa linkkiä ulkopuolisille. Jos käytät yhteiskäyttöistä tietokonetta, muista kirjautua ulos sähköpostiohjelmasta."
                                                      :sv "Om du vill ändra din ansökan, kan du göra ändringar via länken ovan. Dela inte länken vidare till utomstående. Kom ihåg att logga ut från e-postprogrammet om du använder en offentlig dator."
                                                      :en "If you wish to edit your application, you can use the link above. Do not share the link with others. If you are using a public or shared computer, remember to log out of the email application."}})
...
(def virkailija-texts
  {:person-found-matching                                    {:fi "ONR:stä löytyi hakija samalla sähköpostilla, syntymäajalla ja sukupuolella."
   ...
   :person-info-module-onr-astu                              {:fi "ASTU, käyttää ONR:ää"
                                                              :en "ASTU, uses ONR"
                                                              :sv "ASTU, använder ONR"}

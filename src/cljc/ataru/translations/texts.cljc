...
(def kk-application-payment-module-texts
  {:section-title                           {:fi "Hakemusmaksu ja lukuvuosimaksu"
   ...
   :continuous-residence-info               {:fi "Jatkuva oleskelulupa (oleskelulupatyyppi A) voi vapauttaa sinut lukuvuosimaksuvelvollisuudesta, jos se on myönnetty muulla perusteella kuin opiskelua varten. Jatkuva oleskelulupa ei kuitenkaan vapauta lukuvuosimaksuvelvollisuudesta seuraavissa tapauksissa: -\tJos ensimmäinen oleskelulupasi Suomessa on myönnetty opiskelua varten, olet hakemus- ja/tai lukuvuosimaksuvelvollinen, vaikka olisit myöhemmin saanut jatkuvan oleskeluluvan (oleskelulupatyyppi A) muulla perusteella. -\tJos sinulla on jatkuva oleskelulupa (oleskelulupatyyppi A) perhesiteen perusteella ja perheenjäsenesi on alun perin saapunut Suomeen opiskelua varten myönnetyllä oleskeluluvalla, olet myös hakemus- ja/tai lukuvuosimaksuvelvollinen."
                                             :sv "Ett kontinuerligt uppehållstillstånd (typ A) kan befria dig från att betala ansöknings- och/eller läsårsavgift om det beviljas på annan grund än studier. Du är dock skyldig att betala ansöknings- och/eller läsårsavgift i följande fall: - Om ditt första uppehållstillstånd i Finland beviljades för studier är du skyldig att betala ansöknings- och/eller läsårsavgift även om du senare fick ett kontinuerligt uppehållstillstånd (typ A) av annan orsak. - Om du har ett kontinuerligt uppehållstillstånd (typ A) på grund av familjeband och din familjemedlem ursprungligen kom till Finland med uppehållstillstånd för studier, måste du betala ansöknings- och/eller läsårsavgift."
                                             :en "A continuous residence permit (type A) may exempt you from paying application and/or tuition fees if it is granted on grounds other than studying. However, you are required to pay application and/or tuition fees in the following cases: - If your first residence permit in Finland was granted for the purpose of studying, you are required to pay application and/or tuition fees, even if you later obtained a continuous residence permit (type A) on other grounds. - If you have a continuous residence permit (type A) based on family ties, and your family member originally came to Finland on a residence permit granted for studying, you are also required to pay application and/or tuition fees."}

...
(defn get-formatter [fmt-str]
  (.withZone (DateTimeFormatter/ofPattern fmt-str) (ZoneId/of "Europe/Helsinki")))
...
(def finnish-formatter (get-formatter "d.M.yyyy 'klo' HH:mm"))
(def swedish-formatter (get-formatter "d.M.yyyy 'kl.' HH:mm O"))
(def english-formatter (get-formatter "MMM. d, yyyy 'at' hh:mm a O"))
...
(def finnish-time-formatter (get-formatter "'klo' HH:mm"))
(def swedish-time-formatter (get-formatter "'kl.' HH:mm O"))
(def english-time-formatter (get-formatter "'at' hh:mm a O"))

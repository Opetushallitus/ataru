...
(defn- populate-attachment-deadline
  [now hakuajat field-deadlines attachment-deadline-service ohjausparametrit-service application-submitted haku field]
  (let [attachment-deadline-fn (partial attachment-deadline/attachment-deadline-for-hakuaika attachment-deadline-service ohjausparametrit-service application-submitted haku)]

...
(defn- editing-allowed-by-hakuaika?
  [attachment-deadline-service ohjausparametrit-service now field hakuajat application-in-processing-state? application-submitted haku]
  (let [hakuaika            (hakuaika/select-hakuaika-for-field now field hakuajat)
        ...
        attachment-edit-end (attachment-deadline/attachment-deadline-for-hakuaika attachment-deadline-service ohjausparametrit-service application-submitted haku hakuaika)
...
(defn- editing-allowed-by-deadlines?
  [attachment-deadline-service ohjausparametrit-service now field hakuajat roles application-in-processing-state? field-deadline application-submitted haku]
  (or (form-role/virkailija? roles)
      (cond (some? field-deadline)
            ...
            :else
            (editing-allowed-by-hakuaika? attachment-deadline-service ohjausparametrit-service now field hakuajat application-in-processing-state? application-submitted haku))))
...
(defn- uneditable?
  [attachment-deadline-service ohjausparametrit-service now field hakuajat roles application-in-processing-state? field-deadline
  ...
  (not (and (editing-allowed-for-person-info-field? roles field)
            (editing-allowed-by-deadlines? attachment-deadline-service ohjausparametrit-service now field hakuajat roles application-in-processing-state? field-deadline application-submitted haku)
...
(defn flag-uneditable-and-unviewable-field
  [attachment-deadline-service ohjausparametrit-service now hakuajat roles application-in-processing-state? field-deadlines use-toisen-asteen-yhteishaku-restrictions? has-overdue-payment? application-submitted haku field]

...
switch (app) {
  case 'virkailija':
    ...
    break;
  case 'virkailija-edit-link':
    addPhantomCookie();
    url = 'http://localhost:8350/lomake-editori/virkailija-edit-link-test.html'
    break;
  case 'hakija-form':
  ...
  case 'virkailija-hakemus-edit':
     ...
     * */
    url = 'http://localhost:8351/hakemus/virkailija-hakemus-edit-test.html?virkailija-secret=' + cookieOrFormIdOrSecret
    break;
  default:

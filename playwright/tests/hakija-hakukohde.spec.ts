...
// Haku 1.2.246.562.29.65950024186 (mock_tarjonta_service.clj) osoittaa
// hakijan lomakkeeksi tämän avaimen, ja sen hakukohteina on mm.
// Testihakukohde 1-3 (oidit 49028196523-25).
const LOMAKKEEN_AVAIN = '41101b4f-1762-49af-9db0-e3603adae3ae'
...
test.beforeAll(async ({ browser }) => {
  ...
  await luoLomakeAvaimella(page, LOMAKKEEN_AVAIN, sisalto)
...
test('hakukohteen hakutermien syöttäminen palauttaa oikeat hakutulokset', async () => {
  ...
  expect(results).toEqual([
    'Testihakukohde 1 – Koulutuskeskus Sedu, Ilmajoki, Ilmajoentie',
    'Testihakukohde 2 – Koulutuskeskus Sedu, Ilmajoki, Ilmajoentie',

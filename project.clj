(defproject ataru "0.1.0-SNAPSHOT"
  :managed-dependencies [[com.fasterxml.jackson.core/jackson-core "2.11.3"]
  ...
  :dependencies [[org.clojure/clojure "1.10.1"]
                 ...
                 [com.googlecode.owasp-java-html-sanitizer/owasp-java-html-sanitizer "20200713.1" :exclusions [com.google.guava/guava]]
                 [com.amazonaws/aws-java-sdk-s3 "1.11.884"]
                 [com.amazonaws/aws-java-sdk-sns "1.11.884"]
                 [com.amazonaws/aws-java-sdk-sqs "1.11.884"]
  ...
  :profiles {:dev            {:dependencies   [[cider/piggieback "0.5.1"]
             ...
             :test           {:dependencies   [[cider/piggieback "0.5.1"]
                                               [figwheel-sidecar "0.5.20"]
                                               [snipsnap "0.2.0" :exclusions [org.clojure/clojure]]
                                               [reloaded.repl "0.2.4"]
                                               [speclj-junit "0.0.11-20151116.130002-1"]

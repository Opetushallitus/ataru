(defproject ataru "0.1.0-SNAPSHOT"
  :managed-dependencies [;; jackson 2.18.3 -> 2.18.10: CVE-2026-54512/54513 (CRITICAL), CVE-2026-59889 ym.
                         ...
                         [com.fasterxml.jackson.dataformat/jackson-dataformat-cbor "2.18.10"]
  ...
  :dependencies [[org.clojure/clojure "1.11.2"]
                 ...
                 ; 2026-09 tietoturva: 4.1.124 -> 4.2.17.Final (CVE-2026-44249, CVE-2026-75595 CRITICAL ym.);
                 ; java-cas 2.3.0 -> async-http-client 3.0.12 vaatii netty 4.2.x. aleph 0.9.11 toimii 4.2.17:llä.
                 ...
                 ;; JÄÄ AUKI: CVE-2026-11400 + CVE-2026-14265 (HIGH). Korjaus vain 4.0.1:ssä, jonka
                 ;; oletusplugin-lista muuttui (Aurora Initial Connection Strategy) -> katkaisee yhteyden
                 ;; ei-Aurora-postgresiin 30 s timeoutilla. Vaatii db.clj:n wrapperPlugins-konfiguroinnin
                 ;; ja Aurora-failover-polun QA:n -> erillinen tehtävä.
                 ...
                 [opiskelijavalinnat-utils.viestinvalitys/kirjasto "1.2.6-SNAPSHOT"]

  ...
  describe('Selection Limit', function() {
    describe('form creation', function() {
      before(
        ...
        wait.until(function() { return formListItems(0).find('span:eq(0)').text() === 'Selection Limit' })
      )
    ...
    describe('adding elements:', function() {
      describe('create single choice with limited selection', function () {
        before(
          ...
          setTextFieldValue(function () { return formComponents().find('.editor-form__text-field:eq(0)') }, 'Rajoitettu valinta'),
          clickElement(function () { return formComponents().find('.editor-form__checkbox:eq(0) + label') }), // required
          clickElement(function () { return formComponents().find('.editor-form__checkbox:eq(1) + label') }), // selection limit
          clickElement(function () { return formComponents().find('.editor-form__add-dropdown-item a:contains("Lisää")') }),
          setTextFieldValue(function () { return formComponents().find('.editor-form__text-field:eq(1)') }, 'Aina täynnä'),
          setTextFieldValue(function () { return formComponents().find('.editor-form__text-field:eq(2)') }, '0'),
          clickElement(function () { return formComponents().find('.editor-form__add-dropdown-item a:contains("Lisää")') }),
          setTextFieldValue(function () { return formComponents().find('.editor-form__text-field:eq(3)') }, 'Aina tilaa'),
          clickElement(function () { return formComponents().find('.editor-form__add-dropdown-item a:contains("Lisää")') }),
          setTextFieldValue(function () { return formComponents().find('.editor-form__text-field:eq(5)') }, 'Yksi paikka'),
          setTextFieldValue(function () { return formComponents().find('.editor-form__text-field:eq(6)') }, '1')
        )

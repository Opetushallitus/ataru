    ...
    describe('adding elements:', function() {
      ...
      describe('adding multi-answer text field as element to a question group', function() {
        ...
        it('adds multi-answer text field as element to a question group', function() {
          ...
          expect(formComponents().find('.editor-form__followup-question-overlay .editor-form__section_wrapper .editor-form__checkbox:eq(6)').prop('checked')).to.equal(true) // required
          expect(formComponents().find('.editor-form__followup-question-overlay .editor-form__section_wrapper .editor-form__checkbox:eq(7)').prop('checked')).to.equal(true) // multiple answers
        })
      })
      ...
      describe('adding text area as element to a question group', function() {
        before(
          ...
          clickElement(function() { return formComponents().find('.editor-form__followup-question-overlay .editor-form__section_wrapper .editor-form__checkbox + label:eq(9)') })
        )
        it('adds text area as element to a question group', function() {
          ...
          expect(formComponents().find('.editor-form__followup-question-overlay .editor-form__section_wrapper .editor-form__checkbox:eq(9)').prop('checked')).to.equal(true) // required
        })
      })
      ...
      describe('adding single-answer adjacent text field to a question group', function() {
        ...
        it('adds single-answer adjacent text field as element to a question group', function() {
          ...
          expect(formComponents().find('.editor-form__followup-question-overlay .editor-form__section_wrapper .editor-form__checkbox:eq(10)').prop('checked')).to.equal(false) // multiple answers
          ...
          expect(formComponents().find('.editor-form__followup-question-overlay .editor-form__section_wrapper .editor-form__checkbox:eq(11)').prop('checked')).to.equal(true)
      ...
      describe('adding multi-answer adjacent text field to a question group', function() {
        before(
          ...
          clickElement(function() { return formComponents().find('.editor-form__followup-question-overlay .editor-form__section_wrapper .editor-form__checkbox:eq(14) + label') }),
          clickElement(function() { return formComponents().find('.editor-form__followup-question-overlay .editor-form__section_wrapper .editor-form__adjacent-fieldset-container .form__add-component-toolbar--list-item a:contains("Tekstikenttä"):eq(1)') }),
          ...
          clickElement(function() { return formComponents().find('.editor-form__followup-question-overlay .editor-form__section_wrapper .editor-form__checkbox:eq(15) + label') })
        )
        it('adds multi-answer adjacent text field as element to a question group', function() {
          ...
          expect(formComponents().find('.editor-form__followup-question-overlay .editor-form__section_wrapper .editor-form__checkbox:eq(13)').prop('checked')).to.equal(true) // multiple answers
          ...
          expect(formComponents().find('.editor-form__followup-question-overlay .editor-form__section_wrapper .editor-form__checkbox:eq(14)').prop('checked')).to.equal(true)
          ...
          expect(formComponents().find('.editor-form__followup-question-overlay .editor-form__section_wrapper .editor-form__checkbox:eq(15)').prop('checked')).to.equal(true)
          expect(formComponents().find('.editor-form__followup-question-overlay .editor-form__section_wrapper .editor-form__adjacent-fieldset-container .form__add-component-toolbar--list-item a:contains("Pohjakoulutusmoduuli")').length).to.equal(0)
        })
      })

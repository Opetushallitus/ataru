(function () {
  ...
  describe('Virkailija application handling for form with a question group', function () {
    ...
    it('automatically shows the only application belonging to the form', function() {
      ...
      expect(answer(25)).to.equal('Painikkeet, yksi valittavissa: C')
      expect(answer(27)).to.equal('Lista, monta valittavissa: B')
      expect(answer(28)).to.equal('Tekstikenttä, yksi vastaus: B')
      expect(answer(29)).to.equal('Tekstikenttä, monta vastausta: C')
      expect(answer(30)).to.equal('Tekstikenttä, monta vastausta: D')
      expect(answer(31)).to.equal('Tekstialue: BBBBB')

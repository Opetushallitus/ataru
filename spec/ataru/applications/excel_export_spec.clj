  ...
  (it "should export applications for a form without hakukohde or haku"
    (with-excel [file [fixtures/application-for-form]]
      (let [workbook          (WorkbookFactory/create file)
        ...
        (verify-row application-sheet 0 ["Id" "Lähetysaika" "Tila" "Hakukohde" "Hakukohteen OID" "Koulutus" "Kysymys 1" "Kysymys 2" "Kysymys 3" "Muistiinpanot" "Pisteet"])
  ...
  (it "should export applications for a hakukohde with haku"
    (with-excel [file [fixtures/application-for-hakukohde]]
      (let [workbook          (WorkbookFactory/create file)
        ...
        (verify-row metadata-sheet 2 nil)
        (verify-row application-sheet 0 ["Id" "Lähetysaika" "Tila" "Hakukohde" "Hakukohteen OID" "Koulutus" "Kysymys 4" "Kysymys 5" "Muistiinpanot" "Pisteet"])
  ...
  (it "should export applications to separate sheets, grouped by form"
    (with-excel [file [fixtures/application-for-form fixtures/application-for-hakukohde]]
      (let [workbook                    (WorkbookFactory/create file)
        ...
        (verify-row form-application-sheet 0 ["Id" "Lähetysaika" "Tila" "Hakukohde" "Hakukohteen OID" "Koulutus" "Kysymys 1" "Kysymys 2" "Kysymys 3" "Muistiinpanot" "Pisteet"])
        ...
        (verify-row hakukohde-application-sheet 0 ["Id" "Lähetysaika" "Tila" "Hakukohde" "Hakukohteen OID" "Koulutus" "Kysymys 4" "Kysymys 5" "Muistiinpanot" "Pisteet"])

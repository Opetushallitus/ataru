  ...
  (it "should export applications to separate sheets, grouped by form"
    (with-excel [file [fixtures/application-for-form fixtures/application-for-hakukohde]]
      (let [workbook                    (WorkbookFactory/create file)
        ...
        (verify-row form-application-sheet 0 ["Id" "Lähetysaika" "Tila" "Kysymys 1" "Kysymys 2" "Muistiinpanot" "Pisteet"])
        (verify-row form-application-sheet 1 ["application_9432_key" "2016-06-15 15:34:56" "Käsittelemättä" "Vastaus 1" "Vastaus 2" "Some notes about the applicant"])
        (verify-row form-application-sheet 2 nil)
        (verify-row hakukohde-application-sheet 0 ["Id" "Lähetysaika" "Tila" "Kysymys 3" "Kysymys 4" "Muistiinpanot" "Pisteet"])
        (verify-row hakukohde-application-sheet 1 ["application_3424_key" "2016-06-15 15:34:56" "Hylätty" "Vastaus 3" "Vastaus 4" "Some notes about the applicant"])

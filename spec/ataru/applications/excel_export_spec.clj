  ...
  (it "should export applications for a hakukohde with haku"
    (with-excel [file [fixtures/application-for-hakukohde]]
      (let [workbook          (WorkbookFactory/create file)
        ...
        (verify-row application-sheet 1 ["application_3424_key" "2016-06-15 15:34:56" "Hylätty" "1.123.345456567123" "Vastaus 4" "Vastaus 5" "Ajoneuvonosturinkuljettajan ammattitutkinto - Koulutuskeskus Sedu, Ilmajoki, Ilmajoentie (hakukohde.oid)" "Some notes about the applicant"])
        (verify-row application-sheet 2 nil))))
  ...
  (it "should export applications to separate sheets, grouped by form"
    (with-excel [file [fixtures/application-for-form fixtures/application-for-hakukohde]]
      (let [workbook                    (WorkbookFactory/create file)
        ...
        (verify-row hakukohde-application-sheet 1 ["application_3424_key" "2016-06-15 15:34:56" "Hylätty" "1.123.345456567123" "Vastaus 4" "Vastaus 5" "Ajoneuvonosturinkuljettajan ammattitutkinto - Koulutuskeskus Sedu, Ilmajoki, Ilmajoentie (hakukohde.oid)" "Some notes about the applicant"])

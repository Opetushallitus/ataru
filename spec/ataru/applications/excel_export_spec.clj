  ...
  (it "should export applications for a form without hakukohde or haku"
    (with-excel [file [fixtures/application-for-form]]
      (let [workbook          (WorkbookFactory/create file)
        ...
        (verify-row application-sheet 0 ["Id" "Lähetysaika" "Hakemuksen tila" "Kielitaitovaatimus" "Tutkinnon kelpoisuus" "Hakukelpoisuus" "Maksuvelvollisuus" "Valinnan tila" "Hakijan henkilö-OID" "Kysymys 1" "Kysymys 2" "Kysymys 3" "Muistiinpanot" "Pisteet"])
        (verify-row application-sheet 1 ["application_9432_key" "2016-06-15 15:34:56" "Käsittelemättä" "Tarkastamatta" "Täyttyy" "Ei hakukelpoinen" "Tarkastamatta" "Kesken" nil "Vastaus 1" "Vastaus 2" "Vastaus 3" nil])
  ...
  (it "should export applications for a hakukohde with haku"
    (with-excel [file [fixtures/application-for-hakukohde]]
      (let [workbook          (WorkbookFactory/create file)
        ...
        (verify-row metadata-sheet 2 nil)
        (verify-row application-sheet 0 ["Id" "Lähetysaika" "Hakemuksen tila" "Kielitaitovaatimus" "Tutkinnon kelpoisuus" "Hakukelpoisuus" "Maksuvelvollisuus" "Valinnan tila" "Hakijan henkilö-OID" "Kysymys 4" "Kysymys 5" "Hakukohteet" "Muistiinpanot" "Pisteet"])
        (verify-row application-sheet 1 ["application_3424_key" "2016-06-15 15:34:56" "Käsittelyssä" "Tarkastamatta" "Tarkastamatta" "Tarkastamatta" "Tarkastamatta" "Hyväksytty" "1.123.345456567123" "Vastaus 4" "Vastaus 5" "Ajoneuvonosturinkuljettajan ammattitutkinto - Koulutuskeskus Sedu, Ilmajoki, Ilmajoentie (hakukohde.oid)" nil])
        (verify-row application-sheet 2 nil))))
  ...
  (it "should export applications to separate sheets, grouped by form"
    (with-excel [file [fixtures/application-for-form fixtures/application-for-hakukohde]]
      (let [workbook                    (WorkbookFactory/create file)
        ...
        (verify-row form-application-sheet 0 ["Id" "Lähetysaika" "Hakemuksen tila" "Kielitaitovaatimus" "Tutkinnon kelpoisuus" "Hakukelpoisuus" "Maksuvelvollisuus" "Valinnan tila" "Hakijan henkilö-OID" "Kysymys 1" "Kysymys 2" "Kysymys 3" "Muistiinpanot" "Pisteet"])
        (verify-row form-application-sheet 1 ["application_9432_key" "2016-06-15 15:34:56" "Käsittelemättä" "Tarkastamatta" "Täyttyy" "Ei hakukelpoinen" "Tarkastamatta" "Kesken" nil "Vastaus 1" "Vastaus 2" "Vastaus 3" nil])
        (verify-row form-application-sheet 2 nil)
        (verify-row hakukohde-application-sheet 0 ["Id" "Lähetysaika" "Hakemuksen tila" "Kielitaitovaatimus" "Tutkinnon kelpoisuus" "Hakukelpoisuus" "Maksuvelvollisuus" "Valinnan tila" "Hakijan henkilö-OID" "Kysymys 4" "Kysymys 5" "Hakukohteet" "Muistiinpanot" "Pisteet"])
        (verify-row hakukohde-application-sheet 1 ["application_3424_key" "2016-06-15 15:34:56" "Käsittelyssä" "Tarkastamatta" "Tarkastamatta" "Tarkastamatta" "Tarkastamatta" "Hyväksytty" "1.123.345456567123" "Vastaus 4" "Vastaus 5" "Ajoneuvonosturinkuljettajan ammattitutkinto - Koulutuskeskus Sedu, Ilmajoki, Ilmajoentie (hakukohde.oid)" nil])

  ...
  (it "should export applications for a form without hakukohde or haku"
    (with-excel {:skip-answers? false} [file [fixtures/application-for-form]]
      (let [workbook          (WorkbookFactory/create file)
        ...
        (verify-row application-sheet 1 ["application_9432_key" "2016-06-15 15:34:56" "Aktiivinen" "Käsittelemättä" "Tarkastamatta" "Täyttyy" "Ei hakukelpoinen" nil nil "Tarkastamatta" "Kesken" "ei" "12" nil "ei" nil "Vastaus 1" "Vastaus 2" "Lomake-etunimi" "Vastaus 3"])
  ...
  (it "should export applications to separate sheets, grouped by form"
    (with-excel {:skip-answers? false} [file [fixtures/application-for-form fixtures/application-for-hakukohde]]
      (let [workbook                    (WorkbookFactory/create file)
        ...
        (verify-row form-application-sheet 1 ["application_9432_key" "2016-06-15 15:34:56" "Aktiivinen" "Käsittelemättä" "Tarkastamatta" "Täyttyy" "Ei hakukelpoinen" nil nil "Tarkastamatta" "Kesken" "ei" "12" nil "ei" nil "Vastaus 1" "Vastaus 2" "Lomake-etunimi" "Vastaus 3"])
        (verify-row form-application-sheet 2 nil)
        (verify-row hakukohde-application-sheet 0 ["Id" "Lähetysaika" "Hakemuksen tila" "Hakukohteen käsittelyn tila" "Kielitaitovaatimus" "Tutkinnon kelpoisuus" "Hakukelpoisuus" "Hakukelpoisuus asetettu automaattisesti" "Hylkäyksen syy" "Maksuvelvollisuus" "Valinnan tila" "Ehdollinen" "Pisteet" "Hakijan henkilö-OID" "Turvakielto" "Muistiinpanot" "Kysymys 4" "Etunimi" "Kysymys 5" "Hakukohteet"])
        (verify-row hakukohde-application-sheet 1 ["application_3424_key" "2016-06-15 15:34:56" "Aktiivinen" "Käsittelyssä" "Tarkastamatta" "Tarkastamatta" "Tarkastamatta" nil nil "Tarkastamatta" "Hyväksytty" "ei" "12" "1.123.345456567123" "kyllä" "2018-07-29 17:11:12 Virk Ailija: Asia kunnossa,\n2018-07-30 18:12:13 Ajilia Kriv: Muikkari" "Vastaus 4" "Person-etunimi" "Vastaus 5" "(1) Ajoneuvonosturinkuljettajan ammattitutkinto - Koulutuskeskus Sedu, Ilmajoki, Ilmajoentie (hakukohde.oid)"])
      ...
      (with-redefs [form-store/fetch-by-id  (fn [_] fixtures/form-for-multiple-hakukohde)
        ...
        (with-excel {:skip-answers? false :included-ids "" :selected-hakukohde "hakukohde.oid"} [file [fixtures/application-with-special-answers]]
                    (let [workbook          (WorkbookFactory/create file)
                      ...
                      (verify-row application-sheet 1 ["application_3424_key" "2016-06-15 15:34:56" "Aktiivinen" "Käsittelyssä" "Tarkastamatta" "Tarkastamatta" "Tarkastamatta" nil nil "Tarkastamatta" "Hyväksytty" "ei" "12" "1.123.345456567123" "kyllä" "2018-07-29 17:11:12 Virk Ailija: Asia kunnossa,\n2018-07-30 18:12:13 Ajilia Kriv: Muikkari" "Ei" "Person-etunimi" "(1) Ajoneuvonosturinkuljettajan ammattitutkinto - Koulutuskeskus Sedu, Ilmajoki, Ilmajoentie (hakukohde.oid)" "Vastaus 5 will be included only when skip-answers? == false"])
                      (verify-row application-sheet 2 nil)))))

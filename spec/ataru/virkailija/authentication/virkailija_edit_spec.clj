...
(describe "virkailija edit"
  ...
  (before (db/exec :db yesql-upsert-virkailija<! {:oid        "1.2.246.562.11.11111111013"
                                                  :first_name "Hemuli"
                                                  :last_name  "Hemuli?"}))

  (it "creates virkailija credentials"
    (let [secret (virkailija-edit/create-virkailija-update-secret {:identity {:oid        "1.2.246.562.11.11111111013"
                                                                              :username   "hhemuli"
                                                                              :first-name "Hemuli"
                                                                              :last-name  "Hemuli?"}}
                                                                  "test-key")]

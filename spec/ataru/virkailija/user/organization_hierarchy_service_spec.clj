...
(def expected-flat-organizations '({:name {"fi" "Telajärven aikuislukio"}, :oid "1.2.246.562.10.1234334543"}
                                   {:name {"fi" "Telajärven aikuisopisto, Äyhtävä"}, :oid "1.2.246.562.10.123943342"}
                                   {:name {"fi" "Telajärven aikuisopisto, Prunkila"}, :oid "1.2.246.562.10.938234"}
                                   {:name {"sv" "Telajärven hierontaopisto"}, :oid "1.2.246.562.10.423834"}
                                   {:name {"fi" "Telajärven kaupungin työväenopisto"}, :oid "1.2.246.562.10.323412"}))


(describe "organization hierarchy"
          (tags :unit)
          (it "Returns suborganizations"
              (let [parsed-hierarchy (json/parse-string organization-hierarchy-data)
